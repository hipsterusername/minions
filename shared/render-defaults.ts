...
/**
 * Return `layout` with fields equal to their documented default
 * removed. Used to keep the `render_update` envelope's `layout` block
 * minimal when the agent (or the server's defaulting) restated values.
 */
