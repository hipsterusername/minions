...
/**
 * A pure, strict reducer. Phase 1 repositories must bind expected lifecycle
 * revision and currentRunKey in the same CAS transaction around this reducer.
 */
...
/**
 * Structured context that must travel with the Phase 1 work-item snapshot.
...
/** Compatibility adapter used during dual-read migration; it never infers completion from idle. */
