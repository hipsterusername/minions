/**
 * server/harness/tool-result — token-efficient NormalizedToolResult builders.
 *
 * These helpers are the single place tool modules get their result shapes
 * from, so the tests pin the exact contract: terse acks, compact JSON,
 * recursive null-stripping with array positions preserved.
 */
