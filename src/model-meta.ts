 ...
 * (Haiku has no thinking; Opus 4.8 supports xhigh/max; GPT-5.6 Sol
 * supports xhigh).
 *
 ...
 * OpenAI model documentation (`xhigh` via `modelReasoningEffort`).
 */
...
const CODEX_SOL_EFFORTS: EffortLevel[] = ["low", "medium", "high", "xhigh"];
