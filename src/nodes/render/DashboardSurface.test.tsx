/**
 * Tests for DashboardSurface — the presentational embedded dashboard extracted
 * from the retired render node. Covers context selection/copy, the payload
 * error banner, section expand/collapse, and the empty state.
 */
