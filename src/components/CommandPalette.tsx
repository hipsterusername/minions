 ...
 *
 * The input auto-grows to a max height then scrolls. Extracted from Canvas.tsx
 * to keep that file shrinking; matching logic lives in ../node-search.ts.
 */
import {
  useEffect,
  useLayoutEffect,
...
// Grow the input up to this height, then let it scroll internally.
const PALETTE_INPUT_MAX_HEIGHT = 160;
// Cap node matches so the list stays scannable.
